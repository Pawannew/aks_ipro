...
class script(object):
    ...
    START_TXT = environ.get("START_TXT", '''<ʜᴇʟʟᴏ {} 👋🏻  ɪ'ᴍ ᴍᴏᴠɪᴇ ꜰɪʟᴇs sᴇᴀʀᴄʜ ʙᴏᴛ ɪ ᴄᴀɴ sᴇᴀʀᴄʜ ᴀɴʏ ᴛʏᴘᴇs ᴏꜰ ᴍᴏᴠɪᴇs & sᴇʀɪᴇs ɪɴ ꜰɪʟᴇ ꜰᴏʀᴍᴀᴛ..👽>
...
<b>URL buttons:</b>
<code>[Button Text](buttonurl:https://t.me/Aks_support01_bot)</code>
